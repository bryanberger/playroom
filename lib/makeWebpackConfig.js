  ...
  const ourConfig = {
    ...
    resolve: {
      alias: {
        ...
        __PLAYROOM_ALIAS__SHORTLINK_COMPONENT__: playroomConfig.shortlinkComponent
          ? relativeResolve(playroomConfig.shortlinkComponent)
          : require.resolve('./defaultModules/ShortlinkComponent')
      }
    },
    module: {
